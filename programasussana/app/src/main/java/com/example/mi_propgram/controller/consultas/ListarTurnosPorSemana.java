...
public class ListarTurnosPorSemana {

    public static void getData(final String estado, final CallbackInterface<List<DataFileUsers>> callback) {
        DatabaseReference citasRef = FirebaseDatabase.getInstance().getReference().child("cuadroTurnos");
